...
{
    [WorkflowRun]
    public async Task RunAsync(uint providerId, DateTime periodStart, DateTime periodEnd, decimal totalHours, decimal hourlyRate, decimal facilityBillRate)
    {
        // Step 1: Validate Timesheet Rules
        var timesheetId = 1u; // In real scenario, this would be generated by DB
